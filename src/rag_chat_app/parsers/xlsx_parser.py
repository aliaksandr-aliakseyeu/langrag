...
class XlsxParser(Parser):
    """
    Parser for Excel documents (.xlsx and legacy .xls) using Unstructured.
    ...
    def parse(self, metadata: DocumentMetadata) -> List[Document]:
        """
        Parse a Excel file (.xlsx or .xls) and extract structured content.
        ...
        """
        documents = UnstructuredExcelLoader(str(metadata.source_path)).load()
